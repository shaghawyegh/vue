<template>
    ...
    <div @click="checkClick" ref="invoiceWrap" class="invoice-wrap flex flex-column">
      <form @submit.prevent="submitForm" class="invoice-content">
        ...
        <h1 v-if="!editInvoice">فاکتور جدید</h1>
        <h1 v-else>ویرایش فاکتور</h1>
        ...
        <div class="bill-to flex flex-column">
          ...
          <div class="input flex flex-column">
            <label for="clientEmail">ایمیل مشتری</label>
            <input required type="text" id="clientEmail" v-model="clientEmail" />
          </div>
          <div class="input flex flex-column">
            <label for="clientStreetAddress">آدرس</label>
            <input required type="text" id="clientStreetAddress" v-model="clientStreetAddress" />
          </div>
          <div class="location-details flex">
            <div class="input flex flex-column">
              <label for="clientCity">شهر</label>
              <input required type="text" id="clientCity" v-model="clientCity" />
            </div>
            <div class="input flex flex-column">
              <label for="clientZipCode">کد ملی</label>
              <input required type="text" id="clientZipCode" v-model="clientZipCode" />
            </div>
            <div class="input flex flex-column">
              <label for="clientCountry">کشور</label>
        ...
        <div class="save flex">
          <div class="left">
            <button type="button" @click="closeInvoice" class="red">لغو</button>
          </div>
          <div class="right flex">
            <button v-if="!editInvoice" type="submit" @click="saveDraft" class="dark-purple">ذخیره</button>
            <button v-if="!editInvoice" type="submit" @click="publishInvoice" class="purple">ایجاد فاکتور</button>
            <button v-if="editInvoice" type="sumbit" class="purple">به روز رسانی فاکتور</button>
          </div>
        </div>
      </form>
    </div>
